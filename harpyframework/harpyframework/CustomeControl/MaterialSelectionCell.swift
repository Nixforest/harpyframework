...
public class MaterialSelectionCell: UICollectionViewCell {
    // MARK: Properties
    /** Data */
    ...
    //++
    private var _dataVIP: OrderDetailBean   = OrderDetailBean()
    //--
     ...
     * - parameter height:  Height of cell
     */
    public func setDataVIP(data: OrderDetailBean, width: CGFloat, height: CGFloat) {
        self._dataVIP = data
        // Image
        /*if !_data.material_image.isEmpty {
            _imageView.getImgFromUrl(link: _data.material_image, contentMode: _imageView.contentMode)
